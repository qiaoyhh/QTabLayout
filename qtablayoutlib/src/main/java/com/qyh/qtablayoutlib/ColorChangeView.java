...
public class ColorChangeView extends View {
    ...
    public ColorChangeView(Context context, AttributeSet attrs) {
        ...
        mTextChangeColor = ta.getColor(
                R.styleable.ColorChangeView_ctvText_change_color, mTextChangeColor);
        mProgress = ta.getFloat(R.styleable.ColorChangeView_ctvProgress, 0);

        mDirection = ta
                .getInt(R.styleable.ColorChangeView_ctvDirection, mDirection);
